...
eval_jac_g_structure3 <- list( c(4,5,7,9,11) )
...
# beta[4] * (beta[5]*beta[9] + beta[7]*beta[9] + beta[5]*beta[11])
  cdx <- 4
  rdx <- 5
  hess[cdx + rdx*(rdx-1)/2] <- hess[cdx + rdx*(rdx-1)/2] + hessian_lambda[24] * (beta[9] + beta[11])
  cdx <- 4
  rdx <- 7
  ...
  cdx <- 4
  rdx <- 11
  hess[cdx + rdx*(rdx-1)/2] <- hess[cdx + rdx*(rdx-1)/2] + hessian_lambda[24] * beta[5]
  cdx <- 5
  rdx <- 9
